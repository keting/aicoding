...
| Issue 或 Discussion 提案 | 对开源项目做开放式待办盘点，并按成熟度将候选事项分流为可创建 issue 或应继续 discussion。 | [通用 Issue 或 Discussion 提案 Prompt 模板](prompt-templates/issue-or-discussion-proposal.md) |
| 论文调研 | 生成月度论文调研报告，并同步更新论文索引。 | [PAPER_RESEARCH_PROMPT.md](monthly/PAPER_RESEARCH_PROMPT.md) |

## 后续计划补充的 Prompt

以下方向暂未收录成熟模板，欢迎维护者、贡献者和外部使用者在实践中沉淀后补充：
